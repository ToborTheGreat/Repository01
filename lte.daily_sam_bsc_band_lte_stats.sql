...
DROP TRIGGER lte_daily_sam_bsc_band_lte_stats_trigger_part ON lte.daily_sam_bsc_band_lte_stats;
DROP INDEX lte.daily_sam_bsc_band_lte_stats_itmdt_ix;
DROP INDEX lte.daily_sam_bsc_band_lte_stats_idx1;
DROP INDEX lte.daily_sam_bsc_band_lte_stats_idx;
DROP TABLE lte.daily_sam_bsc_band_lte_stats;
SET search_path = lte, pg_catalog;
...
--
-- Name: daily_sam_bsc_band_lte_stats; Type: TABLE; Schema: lte; Owner: -; Tablespace: p2_ltedata
--

CREATE TABLE daily_sam_bsc_band_lte_stats (
...
--
-- Name: daily_sam_bsc_band_lte_stats_idx; Type: INDEX; Schema: lte; Owner: -; Tablespace: p2_lteindex
--

CREATE INDEX daily_sam_bsc_band_lte_stats_idx ON daily_sam_bsc_band_lte_stats USING btree (item_date, market);


--
-- Name: daily_sam_bsc_band_lte_stats_idx1; Type: INDEX; Schema: lte; Owner: -; Tablespace: p2_lteindex
--

CREATE INDEX daily_sam_bsc_band_lte_stats_idx1 ON daily_sam_bsc_band_lte_stats USING btree (market, bsc_name);


--
-- Name: daily_sam_bsc_band_lte_stats_itmdt_ix; Type: INDEX; Schema: lte; Owner: -; Tablespace: p2_lteindex
--

CREATE INDEX daily_sam_bsc_band_lte_stats_itmdt_ix ON daily_sam_bsc_band_lte_stats USING btree (item_date);


--
-- Name: lte_daily_sam_bsc_band_lte_stats_trigger_part; Type: TRIGGER; Schema: lte; Owner: -
--

CREATE TRIGGER lte_daily_sam_bsc_band_lte_stats_trigger_part
    BEFORE INSERT ON daily_sam_bsc_band_lte_stats
    FOR EACH ROW
    EXECUTE PROCEDURE trg_daily_sam_bsc_band_lte_stats_part();
