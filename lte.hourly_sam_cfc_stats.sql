...
DROP TRIGGER hourly_sam_cfc_stats_trigger_part ON lte.hourly_sam_cfc_stats;
DROP INDEX lte.ix1_hourly_sam_cfc_stats;
DROP INDEX lte.hourly_sam_cfc_stats_itmdt_ix;
DROP TABLE lte.hourly_sam_cfc_stats;
SET search_path = lte, pg_catalog;
...
--
-- Name: hourly_sam_cfc_stats; Type: TABLE; Schema: lte; Owner: -; Tablespace: p2_ltedata
--
...
CREATE TABLE hourly_sam_cfc_stats (
    ...
    x0354_ecc_inter_fa_redirection integer,
    x0355_ecc_csfb_config_failure integer
)
...
--
-- Name: hourly_sam_cfc_stats_itmdt_ix; Type: INDEX; Schema: lte; Owner: -; Tablespace: p2_lteindex
--

CREATE INDEX hourly_sam_cfc_stats_itmdt_ix ON hourly_sam_cfc_stats USING btree (item_date);


--
-- Name: ix1_hourly_sam_cfc_stats; Type: INDEX; Schema: lte; Owner: -; Tablespace: p2_lteindex
--

CREATE INDEX ix1_hourly_sam_cfc_stats ON hourly_sam_cfc_stats USING btree (lsm_name, item_date, hour, minute);


--
-- Name: hourly_sam_cfc_stats_trigger_part; Type: TRIGGER; Schema: lte; Owner: -
--
