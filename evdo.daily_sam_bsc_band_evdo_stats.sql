...
DROP TRIGGER evdo_daily_sam_bsc_band_evdo_stats_trigger_part ON evdo.daily_sam_bsc_band_evdo_stats;
DROP INDEX evdo.daily_sam_bsc_band_evdo_stats_idx1;
DROP INDEX evdo.daily_sam_bsc_band_evdo_stats_idx;
ALTER TABLE ONLY evdo.daily_sam_bsc_band_evdo_stats DROP CONSTRAINT daily_sam_bsc_band_evdo_stats_pk;
DROP TABLE evdo.daily_sam_bsc_band_evdo_stats;
SET search_path = evdo, pg_catalog;
...
--
-- Name: daily_sam_bsc_band_evdo_stats; Type: TABLE; Schema: evdo; Owner: -; Tablespace: p2_evdodata
--

CREATE TABLE daily_sam_bsc_band_evdo_stats (
    ...
    a12_auth_complete_pct real,
    bh_a12_auth_complete_pct real,
...
--
-- Name: daily_sam_bsc_band_evdo_stats_pk; Type: CONSTRAINT; Schema: evdo; Owner: -; Tablespace: p2_evdoindex
--

ALTER TABLE ONLY daily_sam_bsc_band_evdo_stats
    ADD CONSTRAINT daily_sam_bsc_band_evdo_stats_pk PRIMARY KEY (item_date, market, bsc_name, band);


--
-- Name: daily_sam_bsc_band_evdo_stats_idx; Type: INDEX; Schema: evdo; Owner: -; Tablespace: p2_evdoindex
--

CREATE INDEX daily_sam_bsc_band_evdo_stats_idx ON daily_sam_bsc_band_evdo_stats USING btree (market, bsc_name);


--
-- Name: daily_sam_bsc_band_evdo_stats_idx1; Type: INDEX; Schema: evdo; Owner: -; Tablespace: p2_evdoindex
--

CREATE INDEX daily_sam_bsc_band_evdo_stats_idx1 ON daily_sam_bsc_band_evdo_stats USING btree (item_date);


--
-- Name: evdo_daily_sam_bsc_band_evdo_stats_trigger_part; Type: TRIGGER; Schema: evdo; Owner: -
--

CREATE TRIGGER evdo_daily_sam_bsc_band_evdo_stats_trigger_part
    BEFORE INSERT ON daily_sam_bsc_band_evdo_stats
    FOR EACH ROW
    EXECUTE PROCEDURE trg_daily_sam_bsc_band_evdo_stats_part();
