...
ALTER TABLE ONLY stg.sam_voice_bts_index_params DROP CONSTRAINT sam_voice_bts_index_params_pk;
DROP TABLE stg.sam_voice_bts_index_params;
SET search_path = stg, pg_catalog;
...
--
-- Name: sam_voice_bts_index_params; Type: TABLE; Schema: stg; Owner: -; Tablespace: p2_stagedata
--

CREATE TABLE sam_voice_bts_index_params (
...
--
-- Name: sam_voice_bts_index_params_pk; Type: CONSTRAINT; Schema: stg; Owner: -; Tablespace: p2_stageindex
--

ALTER TABLE ONLY sam_voice_bts_index_params
    ADD CONSTRAINT sam_voice_bts_index_params_pk PRIMARY KEY (item_date, shorter_bsm_name, bsc_name, bts, index, create_ts);
