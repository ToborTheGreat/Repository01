...
ALTER TABLE ONLY stg.sam_voice_bts_lru_time_params DROP CONSTRAINT sam_voice_bts_lru_time_params_pk;
DROP TABLE stg.sam_voice_bts_lru_time_params;
SET search_path = stg, pg_catalog;
...
--
-- Name: sam_voice_bts_lru_time_params; Type: TABLE; Schema: stg; Owner: -; Tablespace: p2_stagedata
--

CREATE TABLE sam_voice_bts_lru_time_params (
...
--
-- Name: sam_voice_bts_lru_time_params_pk; Type: CONSTRAINT; Schema: stg; Owner: -; Tablespace: p2_stageindex
--

ALTER TABLE ONLY sam_voice_bts_lru_time_params
    ADD CONSTRAINT sam_voice_bts_lru_time_params_pk PRIMARY KEY (item_date, shorter_bsm_name, bsc_name, bts, lru, "time", create_ts);
