...
DROP TRIGGER voice_daily_sam_sector_band_voice_stats_trigger_part ON voice.daily_sam_sector_band_voice_stats;
DROP INDEX voice.daily_sam_sector_band_voice_stats_idx2;
DROP INDEX voice.daily_sam_sector_band_voice_stats_idx1;
DROP INDEX voice.daily_sam_sector_band_voice_stats_idx;
DROP TABLE voice.daily_sam_sector_band_voice_stats;
SET search_path = voice, pg_catalog;
...
--
-- Name: daily_sam_sector_band_voice_stats; Type: TABLE; Schema: voice; Owner: -; Tablespace: p2_voicedata
--

CREATE TABLE daily_sam_sector_band_voice_stats (
    ...
    max_ratio_wc real,
    bh_max_ratio_wc real,
    avg_cur_tx_pwr real,
    max_cur_tx_pwr real,
    sms_attempts integer,
    bh_avg_cur_tx_pwr real,
    bh_max_cur_tx_pwr real,
    bh_sms_attempts integer,
    bsc_market character varying(50),
    avg_tot_tx_pwr real,
    max_tot_tx_pwr real,
    bh_avg_tot_tx_pwr real,
    bh_max_tot_tx_pwr real,
...
--
-- Name: daily_sam_sector_band_voice_stats_idx; Type: INDEX; Schema: voice; Owner: -; Tablespace: p2_voiceindex
--

CREATE INDEX daily_sam_sector_band_voice_stats_idx ON daily_sam_sector_band_voice_stats USING btree (item_date, cascade_id, sector);


--
-- Name: daily_sam_sector_band_voice_stats_idx1; Type: INDEX; Schema: voice; Owner: -; Tablespace: p2_voiceindex
--

CREATE INDEX daily_sam_sector_band_voice_stats_idx1 ON daily_sam_sector_band_voice_stats USING btree (item_date);


--
-- Name: daily_sam_sector_band_voice_stats_idx2; Type: INDEX; Schema: voice; Owner: -; Tablespace: p2_voiceindex
--

CREATE INDEX daily_sam_sector_band_voice_stats_idx2 ON daily_sam_sector_band_voice_stats USING btree (item_date, cascade_id);


--
-- Name: voice_daily_sam_sector_band_voice_stats_trigger_part; Type: TRIGGER; Schema: voice; Owner: -
--

CREATE TRIGGER voice_daily_sam_sector_band_voice_stats_trigger_part
    BEFORE INSERT ON daily_sam_sector_band_voice_stats
    FOR EACH ROW
    EXECUTE PROCEDURE trg_daily_sam_sector_band_voice_stats_part();
