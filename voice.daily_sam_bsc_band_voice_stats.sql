...
DROP TRIGGER voice_daily_sam_bsc_band_voice_stats_trigger_part ON voice.daily_sam_bsc_band_voice_stats;
DROP INDEX voice.daily_sam_bsc_band_voice_stats_itmdt_ix;
ALTER TABLE ONLY voice.daily_sam_bsc_band_voice_stats DROP CONSTRAINT daily_sam_bsc_band_voice_stats_pk;
DROP TABLE voice.daily_sam_bsc_band_voice_stats;
SET search_path = voice, pg_catalog;
...
--
-- Name: daily_sam_bsc_band_voice_stats; Type: TABLE; Schema: voice; Owner: -; Tablespace: p2_voicedata
--

CREATE TABLE daily_sam_bsc_band_voice_stats (
...
ALTER TABLE ONLY daily_sam_bsc_band_voice_stats ALTER COLUMN item_date SET STATISTICS 1000;


SET default_tablespace = p2_voiceindex;

--
-- Name: daily_sam_bsc_band_voice_stats_pk; Type: CONSTRAINT; Schema: voice; Owner: -; Tablespace: p2_voiceindex
--

ALTER TABLE ONLY daily_sam_bsc_band_voice_stats
    ADD CONSTRAINT daily_sam_bsc_band_voice_stats_pk PRIMARY KEY (item_date, market, bsc_name, band);


--
-- Name: daily_sam_bsc_band_voice_stats_itmdt_ix; Type: INDEX; Schema: voice; Owner: -; Tablespace: p2_voiceindex
--

CREATE INDEX daily_sam_bsc_band_voice_stats_itmdt_ix ON daily_sam_bsc_band_voice_stats USING btree (item_date);


--
-- Name: voice_daily_sam_bsc_band_voice_stats_trigger_part; Type: TRIGGER; Schema: voice; Owner: -
--

CREATE TRIGGER voice_daily_sam_bsc_band_voice_stats_trigger_part
    BEFORE INSERT ON daily_sam_bsc_band_voice_stats
    FOR EACH ROW
    EXECUTE PROCEDURE trg_daily_sam_bsc_band_voice_stats_part();
