...
DROP TABLE lte.daily_sam_sector_lte_stats_sammy2069;
SET search_path = lte, pg_catalog;
...
--
-- Name: daily_sam_sector_lte_stats_sammy2069; Type: TABLE; Schema: lte; Owner: -; Tablespace: 
--

CREATE TABLE daily_sam_sector_lte_stats_sammy2069 (
    item_date date,
