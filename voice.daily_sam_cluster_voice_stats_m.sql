...
DROP INDEX voice.daily_sam_cluster_voice_stats_m_itmdt_ix;
DROP INDEX voice.daily_sam_cluster_voice_stats_m_daily_idx;
ALTER TABLE ONLY voice.daily_sam_cluster_voice_stats_m DROP CONSTRAINT daily_sam_cluster_voice_stats_m_pk;
DROP TABLE voice.daily_sam_cluster_voice_stats_m;
SET search_path = voice, pg_catalog;
...
--
-- Name: daily_sam_cluster_voice_stats_m; Type: TABLE; Schema: voice; Owner: -; Tablespace: p2_voicedata
--

CREATE TABLE daily_sam_cluster_voice_stats_m (
...
ALTER TABLE ONLY daily_sam_cluster_voice_stats_m ALTER COLUMN item_date SET STATISTICS 1000;


SET default_tablespace = p2_voiceindex;

--
-- Name: daily_sam_cluster_voice_stats_m_pk; Type: CONSTRAINT; Schema: voice; Owner: -; Tablespace: p2_voiceindex
--

ALTER TABLE ONLY daily_sam_cluster_voice_stats_m
    ADD CONSTRAINT daily_sam_cluster_voice_stats_m_pk PRIMARY KEY (item_date, market, cluster, cluster_group);


--
-- Name: daily_sam_cluster_voice_stats_m_daily_idx; Type: INDEX; Schema: voice; Owner: -; Tablespace: p2_voiceindex
--

CREATE INDEX daily_sam_cluster_voice_stats_m_daily_idx ON daily_sam_cluster_voice_stats_m USING btree (item_date, market, cluster);


--
-- Name: daily_sam_cluster_voice_stats_m_itmdt_ix; Type: INDEX; Schema: voice; Owner: -; Tablespace: p2_voiceindex
--

CREATE INDEX daily_sam_cluster_voice_stats_m_itmdt_ix ON daily_sam_cluster_voice_stats_m USING btree (item_date);
