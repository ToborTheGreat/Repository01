...
DROP INDEX stg.sam_neid_cellnum_relationidx_status_params_ix1;
ALTER TABLE ONLY stg.sam_neid_cellnum_relationidx_status_params DROP CONSTRAINT sam_neid_cellnum_relationidx_status_params_pkey;
DROP TABLE stg.sam_neid_cellnum_relationidx_status_params;
SET search_path = stg, pg_catalog;
...
--
-- Name: sam_neid_cellnum_relationidx_status_params; Type: TABLE; Schema: stg; Owner: -; Tablespace: p2_stagedata
--

CREATE TABLE sam_neid_cellnum_relationidx_status_params (
...
--
-- Name: sam_neid_cellnum_relationidx_status_params_pkey; Type: CONSTRAINT; Schema: stg; Owner: -; Tablespace: p2_stageindex
--

ALTER TABLE ONLY sam_neid_cellnum_relationidx_status_params
    ADD CONSTRAINT sam_neid_cellnum_relationidx_status_params_pkey PRIMARY KEY (item_date, lsm_name, neid, cellnum, relationidx, external_eutracell_fddlogic_status);


--
-- Name: sam_neid_cellnum_relationidx_status_params_ix1; Type: INDEX; Schema: stg; Owner: -; Tablespace: p2_stageindex
--

CREATE INDEX sam_neid_cellnum_relationidx_status_params_ix1 ON sam_neid_cellnum_relationidx_status_params USING btree (item_date, lsm_name);

ALTER TABLE sam_neid_cellnum_relationidx_status_params CLUSTER ON sam_neid_cellnum_relationidx_status_params_ix1;
