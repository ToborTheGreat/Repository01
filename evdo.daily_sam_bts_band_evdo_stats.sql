...
DROP TRIGGER evdo_daily_sam_bts_band_evdo_stats_trigger_part ON evdo.daily_sam_bts_band_evdo_stats;
DROP INDEX evdo.daily_sam_bts_band_evdo_stats_idx1;
DROP INDEX evdo.daily_sam_bts_band_evdo_stats_idx;
DROP TABLE evdo.daily_sam_bts_band_evdo_stats;
SET search_path = evdo, pg_catalog;
...
--
-- Name: daily_sam_bts_band_evdo_stats; Type: TABLE; Schema: evdo; Owner: -; Tablespace: p2_evdodata
--

CREATE TABLE daily_sam_bts_band_evdo_stats (
...
--
-- Name: daily_sam_bts_band_evdo_stats_idx; Type: INDEX; Schema: evdo; Owner: -; Tablespace: p2_evdoindex
--

CREATE INDEX daily_sam_bts_band_evdo_stats_idx ON daily_sam_bts_band_evdo_stats USING btree (item_date, cascade_id);


--
-- Name: daily_sam_bts_band_evdo_stats_idx1; Type: INDEX; Schema: evdo; Owner: -; Tablespace: p2_evdoindex
--

CREATE INDEX daily_sam_bts_band_evdo_stats_idx1 ON daily_sam_bts_band_evdo_stats USING btree (item_date);


--
-- Name: evdo_daily_sam_bts_band_evdo_stats_trigger_part; Type: TRIGGER; Schema: evdo; Owner: -
--

CREATE TRIGGER evdo_daily_sam_bts_band_evdo_stats_trigger_part
    BEFORE INSERT ON daily_sam_bts_band_evdo_stats
    FOR EACH ROW
    EXECUTE PROCEDURE trg_daily_sam_bts_band_evdo_stats_part();
