...
DROP INDEX dw_lte.sam_neid_cellnum_params_dim_ux;
DROP INDEX dw_lte.sam_neid_cellnum_params_dim_n1;
ALTER TABLE ONLY dw_lte.sam_neid_cellnum_params_dim DROP CONSTRAINT sam_neid_cellnum_params_dim_pkey;
DROP TABLE dw_lte.sam_neid_cellnum_params_dim;
SET search_path = dw_lte, pg_catalog;
...
--
-- Name: sam_neid_cellnum_params_dim; Type: TABLE; Schema: dw_lte; Owner: -; Tablespace: p2_dw_ltedata
--

CREATE TABLE sam_neid_cellnum_params_dim (
    sam_neid_cellnum_params_dim_id integer DEFAULT nextval('sam_neid_cellnum_params_dim_seq'::regclass) NOT NULL,
...
--
-- Name: sam_neid_cellnum_params_dim_pkey; Type: CONSTRAINT; Schema: dw_lte; Owner: -; Tablespace: p2_dw_ltedata
--

ALTER TABLE ONLY sam_neid_cellnum_params_dim
    ADD CONSTRAINT sam_neid_cellnum_params_dim_pkey PRIMARY KEY (sam_neid_cellnum_params_dim_id);


--
-- Name: sam_neid_cellnum_params_dim_n1; Type: INDEX; Schema: dw_lte; Owner: -; Tablespace: p2_dw_ltedata
--

CREATE INDEX sam_neid_cellnum_params_dim_n1 ON sam_neid_cellnum_params_dim USING btree (neid, effective_begin, effective_end);


--
-- Name: sam_neid_cellnum_params_dim_ux; Type: INDEX; Schema: dw_lte; Owner: -; Tablespace: p2_dw_ltedata
--

CREATE UNIQUE INDEX sam_neid_cellnum_params_dim_ux ON sam_neid_cellnum_params_dim USING btree (lsm_name, neid, cellnum, effective_begin);
