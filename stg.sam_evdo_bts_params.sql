...
ALTER TABLE ONLY stg.sam_evdo_bts_params DROP CONSTRAINT sam_evdo_bts_params_pk;
DROP TABLE stg.sam_evdo_bts_params;
SET search_path = stg, pg_catalog;
...
--
-- Name: sam_evdo_bts_params; Type: TABLE; Schema: stg; Owner: -; Tablespace: p2_stagedata
--

CREATE TABLE sam_evdo_bts_params (
...
--
-- Name: sam_evdo_bts_params_pk; Type: CONSTRAINT; Schema: stg; Owner: -; Tablespace: p2_stageindex
--

ALTER TABLE ONLY sam_evdo_bts_params
    ADD CONSTRAINT sam_evdo_bts_params_pk PRIMARY KEY (item_date, shorter_bsm_name, bsc_name, bts, create_ts);
