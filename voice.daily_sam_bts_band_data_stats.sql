...
DROP TRIGGER voice_daily_sam_bts_band_data_stats_trigger_part ON voice.daily_sam_bts_band_data_stats;
DROP INDEX voice.daily_sam_bts_band_data_stats_idx;
DROP INDEX voice.daily_sam_bts_band_data_stats_daily_idx;
DROP TABLE voice.daily_sam_bts_band_data_stats;
SET search_path = voice, pg_catalog;
...
--
-- Name: daily_sam_bts_band_data_stats; Type: TABLE; Schema: voice; Owner: -; Tablespace: p2_voicedata
--

CREATE TABLE daily_sam_bts_band_data_stats (
    item_date date,
    vendor text,
...
ALTER TABLE ONLY daily_sam_bts_band_data_stats ALTER COLUMN item_date SET STATISTICS 1000;


SET default_tablespace = p2_voiceindex;

--
-- Name: daily_sam_bts_band_data_stats_daily_idx; Type: INDEX; Schema: voice; Owner: -; Tablespace: p2_voiceindex
--

CREATE INDEX daily_sam_bts_band_data_stats_daily_idx ON daily_sam_bts_band_data_stats USING btree (item_date, cascade_id);


--
-- Name: daily_sam_bts_band_data_stats_idx; Type: INDEX; Schema: voice; Owner: -; Tablespace: p2_voiceindex
--

CREATE INDEX daily_sam_bts_band_data_stats_idx ON daily_sam_bts_band_data_stats USING btree (item_date);


--
-- Name: voice_daily_sam_bts_band_data_stats_trigger_part; Type: TRIGGER; Schema: voice; Owner: -
--

CREATE TRIGGER voice_daily_sam_bts_band_data_stats_trigger_part
    BEFORE INSERT ON daily_sam_bts_band_data_stats
    FOR EACH ROW
    EXECUTE PROCEDURE trg_daily_sam_bts_band_data_stats_part();
