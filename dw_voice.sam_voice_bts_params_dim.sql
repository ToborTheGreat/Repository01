...
DROP INDEX dw_voice.sam_voice_bts_params_dim_ux;
DROP INDEX dw_voice.sam_voice_bts_params_dim_i1;
ALTER TABLE ONLY dw_voice.sam_voice_bts_params_dim DROP CONSTRAINT sam_voice_bts_params_dim_pk;
DROP TABLE dw_voice.sam_voice_bts_params_dim;
SET search_path = dw_voice, pg_catalog;
...
--
-- Name: sam_voice_bts_params_dim; Type: TABLE; Schema: dw_voice; Owner: -; Tablespace: p2_dw_voicedata
--

CREATE TABLE sam_voice_bts_params_dim (
    sam_voice_bts_params_dim_id integer DEFAULT nextval('sam_voice_bts_params_dim_seq'::regclass) NOT NULL,
...
--
-- Name: sam_voice_bts_params_dim_pk; Type: CONSTRAINT; Schema: dw_voice; Owner: -; Tablespace: p2_dw_voiceindex
--

ALTER TABLE ONLY sam_voice_bts_params_dim
    ADD CONSTRAINT sam_voice_bts_params_dim_pk PRIMARY KEY (sam_voice_bts_params_dim_id);


--
-- Name: sam_voice_bts_params_dim_i1; Type: INDEX; Schema: dw_voice; Owner: -; Tablespace: p2_dw_voiceindex
--

CREATE INDEX sam_voice_bts_params_dim_i1 ON sam_voice_bts_params_dim USING btree (shorter_bsm_name, bts, effective_begin, effective_end);


--
-- Name: sam_voice_bts_params_dim_ux; Type: INDEX; Schema: dw_voice; Owner: -; Tablespace: p2_dw_voiceindex
--

CREATE UNIQUE INDEX sam_voice_bts_params_dim_ux ON sam_voice_bts_params_dim USING btree (shorter_bsm_name, bsc_name, bts, effective_begin);
