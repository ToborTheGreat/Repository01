...
DROP INDEX xops.schema_columns_n1;
DROP TABLE xops.schema_columns;
SET search_path = xops, pg_catalog;
...
--
-- Name: schema_columns; Type: TABLE; Schema: xops; Owner: -; Tablespace: p2_generaldata
--
...
--
-- Name: schema_columns_n1; Type: INDEX; Schema: xops; Owner: -; Tablespace: p2_generaldata
--

CREATE INDEX schema_columns_n1 ON schema_columns USING btree (table_schema, table_name);
