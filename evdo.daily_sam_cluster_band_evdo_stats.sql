...
DROP TRIGGER evdo_daily_sam_cluster_band_evdo_stats_trigger_part ON evdo.daily_sam_cluster_band_evdo_stats;
DROP INDEX evdo.daily_sam_cluster_band_evdo_stats_idx1;
DROP INDEX evdo.daily_sam_cluster_band_evdo_stats_idx;
ALTER TABLE ONLY evdo.daily_sam_cluster_band_evdo_stats DROP CONSTRAINT daily_sam_cluster_band_evdo_stats_pk;
DROP TABLE evdo.daily_sam_cluster_band_evdo_stats;
SET search_path = evdo, pg_catalog;
...
--
-- Name: daily_sam_cluster_band_evdo_stats; Type: TABLE; Schema: evdo; Owner: -; Tablespace: p2_evdodata
--

CREATE TABLE daily_sam_cluster_band_evdo_stats (
    item_date date NOT NULL,
    vendor character varying(30),
    market character varying(50) NOT NULL,
    cluster character varying(50) NOT NULL,
    cluster_group character varying(50) NOT NULL,
    ...
    qchat_ptt_post_first_page_successes bigint,
...
--
-- Name: daily_sam_cluster_band_evdo_stats_pk; Type: CONSTRAINT; Schema: evdo; Owner: -; Tablespace: p2_evdoindex
--

ALTER TABLE ONLY daily_sam_cluster_band_evdo_stats
    ADD CONSTRAINT daily_sam_cluster_band_evdo_stats_pk PRIMARY KEY (item_date, market, cluster, cluster_group, band);


--
-- Name: daily_sam_cluster_band_evdo_stats_idx; Type: INDEX; Schema: evdo; Owner: -; Tablespace: p2_evdoindex
--

CREATE INDEX daily_sam_cluster_band_evdo_stats_idx ON daily_sam_cluster_band_evdo_stats USING btree (market, cluster);


--
-- Name: daily_sam_cluster_band_evdo_stats_idx1; Type: INDEX; Schema: evdo; Owner: -; Tablespace: p2_evdoindex
--

CREATE INDEX daily_sam_cluster_band_evdo_stats_idx1 ON daily_sam_cluster_band_evdo_stats USING btree (item_date);


--
-- Name: evdo_daily_sam_cluster_band_evdo_stats_trigger_part; Type: TRIGGER; Schema: evdo; Owner: -
--

CREATE TRIGGER evdo_daily_sam_cluster_band_evdo_stats_trigger_part
    BEFORE INSERT ON daily_sam_cluster_band_evdo_stats
    FOR EACH ROW
    EXECUTE PROCEDURE trg_daily_sam_cluster_band_evdo_stats_part();
